#   
# pub_med.py written by Jannek Ulm 11.10.2022 (Bachelor Thesis)
# 
#   
                        ...
                        for id_trans, trans in enumerate(transs):
                            for id_init, init in enumerate(inits):
                                for id_neighborhood, neighborhood_size in enumerate(neighborhood_sizes):
                                    ...
                                    try:
                                        parser = argparse.ArgumentParser(description='Planetoid-PubMed (AgentNet)')
                                        parser = add_model_args(parser)
                                        args = parser.parse_args()
                                        args.dataset = "planetoid-pubmed"
